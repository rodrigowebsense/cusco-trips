...
export const enum_tours_best_season = pgEnum('enum_tours_best_season', [
  'spring',
  'summer',
  'autumn',
  'winter',
...
export const tours_gallery = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('tours_gallery_order_idx').on(columns._order),
    _parentIDIdx: index('tours_gallery_parent_id_idx').on(columns._parentID),
    tours_gallery_image_idx: index('tours_gallery_image_idx').on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
...
export const tours_gallery_locales = pgTable(
  'tours_gallery_locales',
  {
  ...
  (columns) => ({
    _localeParent: uniqueIndex('tours_gallery_locales_locale_parent_id_unique').on(
      columns._locale,
      columns._parentID,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [tours_gallery.id],
      name: 'tours_gallery_locales_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const tours_highlights = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('tours_highlights_order_idx').on(columns._order),
    _parentIDIdx: index('tours_highlights_parent_id_idx').on(columns._parentID),
    _localeIdx: index('tours_highlights_locale_idx').on(columns._locale),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [tours.id],
...
export const tours_included = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('tours_included_order_idx').on(columns._order),
    _parentIDIdx: index('tours_included_parent_id_idx').on(columns._parentID),
    _localeIdx: index('tours_included_locale_idx').on(columns._locale),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [tours.id],
...
export const tours_excluded = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('tours_excluded_order_idx').on(columns._order),
    _parentIDIdx: index('tours_excluded_parent_id_idx').on(columns._parentID),
    _localeIdx: index('tours_excluded_locale_idx').on(columns._locale),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [tours.id],
...
export const tours_itinerary_activities = pgTable(
  'tours_itinerary_activities',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    _locale: enum__locales('_locale').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('tours_itinerary_activities_order_idx').on(columns._order),
    _parentIDIdx: index('tours_itinerary_activities_parent_id_idx').on(columns._parentID),
    _localeIdx: index('tours_itinerary_activities_locale_idx').on(columns._locale),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [tours_itinerary.id],
      name: 'tours_itinerary_activities_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const tours_itinerary = pgTable(
  'tours_itinerary',
  {
    ...
    _locale: enum__locales('_locale').notNull(),
    id: varchar('id').primaryKey(),
    day: numeric('day').notNull(),
    title: varchar('title').notNull(),
    description: jsonb('description'),
  },
  (columns) => ({
    _orderIdx: index('tours_itinerary_order_idx').on(columns._order),
    _parentIDIdx: index('tours_itinerary_parent_id_idx').on(columns._parentID),
    _localeIdx: index('tours_itinerary_locale_idx').on(columns._locale),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [tours.id],
...
export const tours_best_season = pgTable(
  'tours_best_season',
  {
    order: integer('order').notNull(),
    parent: integer('parent_id').notNull(),
    value: enum_tours_best_season('value'),
    id: serial('id').primaryKey(),
  },
  (columns) => ({
    orderIdx: index('tours_best_season_order_idx').on(columns.order),
    parentIdx: index('tours_best_season_parent_idx').on(columns.parent),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [tours.id],
      name: 'tours_best_season_parent_fk',
    }).onDelete('cascade'),
  }),
)
...
export const tours = pgTable(
  'tours',
  {
    ...
    difficulty: enum_tours_difficulty('difficulty').notNull(),
    ...
    max_group_size: numeric('max_group_size').notNull(),
    minimum_age: numeric('minimum_age').notNull(),
    featured: boolean('featured').default(false),
    rating: numeric('rating'),
    reviews_count: numeric('reviews_count').default('0'),
    slug: varchar('slug'),
    slugLock: boolean('slug_lock').default(true),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
  ...
  (columns) => ({
    tours_image_idx: index('tours_image_idx').on(columns.image),
    tours_category_idx: index('tours_category_idx').on(columns.category),
    tours_slug_idx: index('tours_slug_idx').on(columns.slug),
...
export const tours_locales = pgTable(
  ...
  (columns) => ({
    _localeParent: uniqueIndex('tours_locales_locale_parent_id_unique').on(
      columns._locale,
      columns._parentID,
    ),
    _parentIdFk: foreignKey({
...
export const relations_tours_gallery_locales = relations(tours_gallery_locales, ({ one }) => ({
  _parentID: one(tours_gallery, {
    fields: [tours_gallery_locales._parentID],
    references: [tours_gallery.id],
    relationName: '_locales',
  }),
}))
export const relations_tours_gallery = relations(tours_gallery, ({ one, many }) => ({
  _parentID: one(tours, {
    fields: [tours_gallery._parentID],
    references: [tours.id],
    relationName: 'gallery',
  }),
  _locales: many(tours_gallery_locales, {
    relationName: '_locales',
  }),
  image: one(media, {
...
export const relations_tours_included = relations(tours_included, ({ one }) => ({
  _parentID: one(tours, {
...
export const relations_tours_excluded = relations(tours_excluded, ({ one }) => ({
  _parentID: one(tours, {
...
export const relations_tours_itinerary_activities = relations(
  tours_itinerary_activities,
  ({ one }) => ({
    _parentID: one(tours_itinerary, {
      fields: [tours_itinerary_activities._parentID],
...
export const relations_tours_itinerary = relations(tours_itinerary, ({ one, many }) => ({
  ...
  activities: many(tours_itinerary_activities, {
    relationName: 'activities',
  }),
}))
export const relations_tours_best_season = relations(tours_best_season, ({ one }) => ({
  parent: one(tours, {
    fields: [tours_best_season.parent],
    references: [tours.id],
    relationName: 'best_season',
  }),
}))
...
export const relations_tours = relations(tours, ({ one, many }) => ({
  ...
  best_season: many(tours_best_season, {
    relationName: 'best_season',
  }),
...
type DatabaseSchema = {
  ...
  enum_tours_best_season: typeof enum_tours_best_season
  ...
  tours_gallery_locales: typeof tours_gallery_locales
  tours_highlights: typeof tours_highlights
  tours_included: typeof tours_included
  tours_excluded: typeof tours_excluded
  tours_itinerary_activities: typeof tours_itinerary_activities
  tours_itinerary: typeof tours_itinerary
  tours_best_season: typeof tours_best_season
  tours: typeof tours
  ...
  relations_tours_gallery_locales: typeof relations_tours_gallery_locales
  ...
  relations_tours_itinerary_activities: typeof relations_tours_itinerary_activities
  relations_tours_itinerary: typeof relations_tours_itinerary
  relations_tours_best_season: typeof relations_tours_best_season
